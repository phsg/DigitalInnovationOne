...
/**
 * Desafio Romeu e Julieta acabaram de casar e estão planejamendo a Lua de Mel
 * na Europa. Como vão visitar vários países, o fuso horário de cada um é
 ...
 * 
 * Entrada A entrada contém 3 inteiros: S (0 <= S <= 23), T (1 <= T <= 12) e F
 * (-5 <= F <= 5), separados por um espaço, indicando respectivamente a hora da
 * saída, o tempo de viagem e o fuso horário do destino com relação à origem.
 * 
 * Saída Imprima um inteiro que indica a hora local prevista no destino,
