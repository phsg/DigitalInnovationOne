 ...
 * da Alemanhã. No entanto, os estudante acharam estranho, uma vez que na
 * Alemanhã o sistema de notas é diferente: as notas devem ser dadas como
 * conceitos de A a E. O conceito A é o mais alto, enquanto o conceito E é o
 * mais baixo.
 * 
 * Conversando com outros docentes, ela recebeu a sugestão de utilizar a
 ...
 * dispositivo de entrada padrão (normalmente o teclado). A entrada contém uma
 * única linha com um número inteiro N (0 <= N <= 100), representando uma nota
 * de prova no sistema numérico.
 * 
 * Saída Seu programa deve imprimir, na saída padrão, uma letra (A, B, C, D, ou
 * E em maiúsculas) representando o conceito correspondente à nota dada na
 * entrada.
 * 
 * 
 * Exemplos de Entrada Exemplos de Saída 12
 * 
 * D
 * 
 * 
